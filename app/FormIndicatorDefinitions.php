...
class FormIndicatorDefinitions
{
    ...
    public static clinicalIndicators () {
    ...
    public static counselingIndicators () {
    ...
    public static laboratoryIndicators () {
    ...
    public static pharmacyIndicators () {
    ...
    public static nutritionIndicators () {
