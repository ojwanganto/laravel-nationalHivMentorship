...
Vromansys.Payment = new function() {
	...
	return {
		...
		payStripe: function(key, opts) {
			...
			handler.open({ allowRememberMe:opts.allowRememberMe, billingAddress:opts.billingAddress, description:opts.description, email:opts.email, name:opts.name, panelLabel:opts.panelLabel });
		}
	};
}();
