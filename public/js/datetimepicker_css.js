...
function RenderCssCal(bNewCal)
{
	...
	{
	    vCalHeader += "<td align='center'><select name='MonthSelector' onChange='javascript:Cal.SwitchMth(this.selectedIndex);RenderCssCal();'  style='width:120px'>";
		for (i = 0; i < 12; i += 1)
		{
			if (i === Cal.Month)
			{
		...
		vCalHeader += "<td align='center'><select name='YearSelector' size='1' onChange='javascript:Cal.SwitchYear(this.value);RenderCssCal();' style='width:60px'>";
	...
	for (j = 1; j <= Cal.GetMonDays(); j += 1)
	{
        ...
        else if (Cal.EnableDateMode === "past" && ((j >= dtToday.getDate()+1) && (Cal.Month === dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()) || (Cal.Month > dtToday.getMonth()) && (Cal.Year === dtToday.getFullYear()) || (Cal.Year > dtToday.getFullYear()))) {
