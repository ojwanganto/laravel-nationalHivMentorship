...
<tr>
<td colspan="4"><textarea cols="70" name="session_objectives"></textarea></td>
</tr>
...
<td><input type="radio" @if($sessionScore['ind_2']==4) checked @endif name="ind_2" class="multiple_choice" id="freedom-2" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_29']==4) checked @endif name="ind_29" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_30']==4) checked @endif name="ind_30" class="multiple_choice" id="freedom-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_31']==4) checked @endif name="ind_31" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_32']==4) checked @endif name="ind_32" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_33']==4) checked @endif name="ind_33" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_34']==4) checked @endif name="ind_34" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_35']==4) checked @endif name="ind_35" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_36']==4) checked @endif name="ind_36" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_37']==4) checked @endif name="ind_37" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_38']==4) checked @endif name="ind_38" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_39']==4) checked @endif name="ind_39" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_40']==4) checked @endif name="ind_40" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_41']==4) checked @endif name="ind_41" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_42']==4) checked @endif name="ind_42" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_43']==4) checked @endif name="ind_43" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_44']==4) checked @endif name="ind_44" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_45']==4) checked @endif name="ind_45" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_46']==4) checked @endif name="ind_46" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_47']==4) checked @endif name="ind_47" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_48']==4) checked @endif name="ind_48" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_49']==4) checked @endif name="ind_49" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_50']==4) checked @endif name="ind_50" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_51']==4) checked @endif name="ind_51" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_52']==4) checked @endif name="ind_52" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_53']==4) checked @endif name="ind_53" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
...
<td><input type="radio" @if($sessionScore['ind_54']==4) checked @endif name="ind_54" class="multiple_choice" id="RESULT_RadioButton-4-0-3" value="4" /></td>
